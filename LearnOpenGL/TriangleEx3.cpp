...
int main()
{
  ...
  // link shaders for yellow fragments
  ...
  GLuint VBOs[numTriangles], VAOs[numTriangles];
  ...
  for (int i = 0; i < numTriangles; ++i) {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices) / numTriangles, vertices + i * numVertices / numTriangles * 3, GL_STATIC_DRAW);
  ...
  // ------------------------------------------------------------------------
  glDeleteVertexArrays(numTriangles, VAOs);
  glDeleteBuffers(numTriangles, VBOs);
